...
const Work = ({data}) => {
    ...
    return (
        <div>
            <Card style={{margin : '8px', paddingLeft : '5px' ,height : '90px'}}>
                    <Card.Body style={{ padding : '10px', display: 'grid', gridTemplateRows: '20px 25px 20px',gridTemplateColumns:'15px 100px 10px 350px 215px 50px',marginBottom:'0px', height: '80px'}}>
                        ...
                        <Card.Text style={{gridColumn :'6/7', gridRow :'1/2'}}> D-{(new Date(data.wl_date_end).getTime() - new Date(data.wl_date_start).getTime())/ (1000*60*60*24)}</Card.Text>     
