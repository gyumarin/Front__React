...
const CommitWorkList = ({userBool, onGitWorkList, projectID}) => {
    ...
    return (
        ...
        <div>
            ...
            <div style={{ marginLeft : '40px', height : '220px', width:'530px', backgroundColor:'white', textAlign:'center' ,paddingTop:'100px' }}> 해당 사용자가 아니 사용하실 수 없습니다. </div>
            }
        </div>
